...
import (
	...
	"book/internal/data/ent/migrate"
...
// Create returns a create builder for Greeter.
...
func (c *GreeterClient) UpdateOneID(id int64) *GreeterUpdateOne {
...
func (c *GreeterClient) DeleteOneID(id int64) *GreeterDeleteOne {
...
func (c *GreeterClient) Get(ctx context.Context, id int64) (*Greeter, error) {
	return c.Query().Where(greeter.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *GreeterClient) GetX(ctx context.Context, id int64) *Greeter {
