...
func NewGreeterHandler(srv GreeterHandler, opts ...http1.HandleOption) http.Handler {
	...
	r.HandleFunc("/api.greeter.v1.Greeter/CreateGreeter", func(w http.ResponseWriter, r *http.Request) {
	...
	r.HandleFunc("/api.greeter.v1.Greeter/UpdateGreeter", func(w http.ResponseWriter, r *http.Request) {
	...
	r.HandleFunc("/api.greeter.v1.Greeter/DeleteGreeter", func(w http.ResponseWriter, r *http.Request) {
	...
	r.HandleFunc("/api.greeter.v1.Greeter/GetGreeter", func(w http.ResponseWriter, r *http.Request) {
